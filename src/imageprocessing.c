...
imagem abrir_imagem(char *nome_do_arquivo) {
  ...
  I.width = x;
  I.height = y;
  I.r = mmap(NULL, sizeof(float) * x * y, PROT, FLAGS, 0, 0);
  I.g = mmap(NULL, sizeof(float) * x * y, PROT, FLAGS, 0, 0);
  I.b = mmap(NULL, sizeof(float) * x * y, PROT, FLAGS, 0, 0);
...
void liberar_imagem(imagem *I) {
  munmap(I->r, sizeof(float) * I->width * I->height);
  munmap(I->g, sizeof(float) * I->width * I->height);
  munmap(I->b, sizeof(float) * I->width * I->height);
}
